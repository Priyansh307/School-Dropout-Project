  ...
  const fetchStudentData = async (standard) => {
    try {
      ...
      const response = await axios.get(
        "http://localhost:3000/auth/studentcard",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
          params: { standard }, // Pass the selected standard as a query parameter
        }
      );
    ...
    <div className="std_wise_container">
      ...
      {activeStandard ? (
        <div className="sd_grid_container">
          ...
          <button className="back_btn" onClick={() => setActiveStandard(null)}>
            Back
          </button>
        </div>
      ) : (
        <div className={`standard-list ${navVisible ? 'nav-visible' : 'nav-hidden'}`}>
          <div className="primary">
            ...
            <div
              className="standard-box"
              onClick={() => handleStandardClick("Standard 3")}
            >
              Standard 3
            </div>
            <div
              className="standard-box"
              onClick={() => handleStandardClick("Standard 4")}
            >
              Standard 4
            </div>
            <div
              className="standard-box"
              onClick={() => handleStandardClick("Standard 5")}
            >
              Standard 5
            </div>
            <div
              className="standard-box"
              onClick={() => handleStandardClick("Standard 6")}
            >
              Standard 6
            </div>
            <div
              className="standard-box"
              onClick={() => handleStandardClick("Standard 7")}
            >
              Standard 7
            </div>
            <div
              className="standard-box"
              onClick={() => handleStandardClick("Standard 8")}
            >
              Standard 8
            </div>
          </div>
          <div className="secondary">
            ...
            <div
              className="standard-box"
              onClick={() => handleStandardClick("Standard 9")}
            >
              Standard 9
            </div>
            <div
              className="standard-box"
              onClick={() => handleStandardClick("Standard 10")}
            >
              Standard 10
            </div>
          </div>
          <div className="higher-secondary">
            ...
            <div
              className="standard-box"
              onClick={() => handleStandardClick("Standard 11")}
            >
              Standard 11
            </div>
            <div
              className="standard-box"
              onClick={() => handleStandardClick("Standard 12")}
            >
              Standard 12
            </div>
          </div>
