    ...
    <div className="container_goverment_chart">
      <div className="drop_out_income_wise_container_goverment">
        ...
        <div className="g_dropout_ratio_goverment">
          <p>Income (0-10000): {studentCounts[0]}</p>
          <p>Income (10001-50000): {studentCounts[1]}</p>
          <p>Income (50001-100000): {studentCounts[2]}</p>
          <p>Income (100000 above): {studentCounts[3]}</p>
        </div>
